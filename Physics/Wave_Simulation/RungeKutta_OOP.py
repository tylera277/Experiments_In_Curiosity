...
class RungeKutta:
    ...
    def __init__(self, wave_object, time_step_size, testing=False):
        # Shortened notation
        wo = wave_object

        self.y = wo.y_position
        self.v_y = wo.y_velocity
        self.dt = time_step_size

        # Systems constants/parameters
        self.c = wo.damping_coefficient
        self.k = wo.spring_constant
        self.mass = wo.mass
        self.resting_length = wo.resting_length

        # Number of springs in the system
        self.N = wo.number_of_springs
    ...
    def k3_vy(self, i):
        ...
        position_term = - (self.k / self.mass) * (self.y[i]- self.resting_length[i] + self.k2_y(i)*(self.dt/2.0))
    ...
    def k4_vy(self, i):
        ...
        position_term = - (self.k / self.mass) * (self.y[i]- self.resting_length[i] + self.dt*self.k3_y(i))
